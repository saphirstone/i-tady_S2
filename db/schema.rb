...
ActiveRecord::Schema.define(version: 20180918112327) do
  ...
  create_table "assistant_realisateurs", force: :cascade do |t|
    t.string   "nom_et_prenom"
    t.string   "email"
    t.text     "info_carriere"
    t.text     "ambition"
  ...
  create_table "cadreurs", force: :cascade do |t|
    t.string   "nom_et_prenom"
    t.string   "numero"
    t.string   "email"
    t.text     "info_carriere"
  ...
  create_table "chef_de_projet_webs", force: :cascade do |t|
    t.string   "nom_et_prenom"
    t.string   "numero"
    t.string   "email"
    t.text     "info_carriere"
  ...
  create_table "chef_decorateurs", force: :cascade do |t|
    t.string   "nom_et_prenom"
    t.string   "email"
    t.text     "info_carriere"
    t.string   "specialite"
  ...
  create_table "chef_electriciens", force: :cascade do |t|
    t.string   "nom_et_prenom"
    t.string   "numero"
    t.string   "email"
    t.string   "equipe"
  ...
  create_table "chef_operateurs", force: :cascade do |t|
    t.string   "nom_et_prenom"
    t.string   "email"
    t.text     "info_carriere"
    t.text     "ambition"
  ...
  create_table "monteur_videos", force: :cascade do |t|
    t.string   "nom_et_prenom"
    t.string   "numero"
    t.string   "email"
    t.string   "equipement"
  ...
  create_table "perchistes", force: :cascade do |t|
    t.string   "nom_et_prenom"
    t.string   "numero"
    t.string   "email"
    t.string   "equipement"
  ...
  create_table "regiseurs", force: :cascade do |t|
    t.string   "nom_et_prenom"
    t.string   "email"
    t.text     "info_carriere"
    t.text     "ambition"
  ...
  create_table "scenaristes", force: :cascade do |t|
    t.string   "nom_et_prenom"
    t.string   "numero"
    t.string   "email"
    t.text     "info_carriere"
  ...
  create_table "scriptes", force: :cascade do |t|
    t.string   "nom_et_prenom"
    t.string   "numero"
    t.string   "email"
    t.text     "info_carriere"
